...
class Enqueue {
	...
	public function enqueue_public() {
		...
		wp_enqueue_script( 'dunn-public', get_theme_file_uri( '/assets/js/public.min.js' ), array( 'jquery' ), PARENT_THEME_VERSION, true );
	...
	public static function fonts_url() {
		...
		$return 	= '';
		$families 	= '';
		$fonts[] 	= array( 'font' => 'Open Sans', 'weights' => '400,700', 'translate' => esc_html_x( 'on', 'Open Sans font: on or off', 'dunn' ) );

...
class Uploads {
	...
	public function add_mime_types( $post_mime_types ) {
		...
		$post_mime_types['application/pdf'] = array( esc_html__( 'PDFs', 'dunn' ), esc_html__( 'Manage PDFs', 'dunn' ), _n_noop( 'PDF <span class="count">(%s)</span>', 'PDFs <span class="count">(%s)</span>', 'dunn' ) );
		$post_mime_types['text/x-vcard'] 	= array( esc_html__( 'vCards', 'dunn' ), esc_html__( 'Manage vCards', 'dunn' ), _n_noop( 'vCard <span class="count">(%s)</span>', 'vCards <span class="count">(%s)</span>', 'dunn' ) );

...
class Customizer {
	...
	public function register_sections( $wp_customize ) {
		...
		$wp_customize->add_section( 'tablet_menu',
			array(
				...
				'priority'  		=> 10,
				'theme_supports'  	=> '',
				'title'  			=> esc_html__( 'Tablet Menu Style', 'dunn' ),
			)
		);
		...
		$wp_customize->add_control(
			new \WP_Customize_Media_Control(
				...
				array(
					'active_callback' 	=> '',
					'description' 		=> esc_html__( '', 'dunn' ),
					'label' 			=> esc_html__( 'Default Featured Image', 'dunn' ),
					'priority' 			=> 10,
					'section' 			=> 'images',
	...
	public function register_fields_menus( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				'active_callback' 	=> '',
				'choices' 			=> array(
					'tablet-slide-ontop-from-left' 		=> esc_html__( 'Slide On Top from Left', 'dunn' ),
					'tablet-slide-ontop-from-right' 	=> esc_html__( 'Slide On Top from Right', 'dunn' ),
					'tablet-slide-ontop-from-top' 		=> esc_html__( 'Slide On Top from Top', 'dunn' ),
					'tablet-slide-ontop-from-bottom' 	=> esc_html__( 'Slide On Top from Bottom', 'dunn' ),
					'tablet-push-from-left' 			=> esc_html__( 'Push In from Left', 'dunn' ),
					'tablet-push-from-right' 			=> esc_html__( 'Push In from Right', 'dunn' ),
				),
				'description' 		=> esc_html__( 'Select how the tablet menu appears.', 'dunn' ),
				'label'  			=> esc_html__( 'Tablet Menu', 'dunn' ),
				'priority' 			=> 10,
				'section'  			=> 'tablet_menu',
	...
	public function register_fields_siteid( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				'active_callback' 	=> '',
				'description' 		=> esc_html__( 'Enter the Google Tag Manager container ID.', 'dunn' ),
				'label'  			=> esc_html__( 'Google Tag Manager ID', 'dunn' ),
				'priority' 			=> 10,

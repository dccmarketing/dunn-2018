 ...
 * sudo npm install --save-dev gulp-sourcemaps gulp-autoprefixer gulp-filter gulp-clean-css gulp-concat gulp-uglify-es gulp-notify gulp-imagemin gulp-rename gulp-wp-pot gulp-sort gulp-parker gulp-svgmin gulp-size

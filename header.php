...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding"><?php
			...
			$dunn_brothers_description = get_bloginfo( 'description', 'display' );
			
			if ( $dunn_brothers_description || is_customize_preview() ) :
			
				?><p class="site-description"><?php 
				
					echo $dunn_brothers_description; /* WPCS: xss ok. */ 
